...
// non-string attribute is a soft miss (false), while a non-string prefix
// is a config error and throws — evaluate() maps that to reason "error",
// matching how the Go evaluator propagates the decode failure.
